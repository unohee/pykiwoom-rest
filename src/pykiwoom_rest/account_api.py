...
class AccountAPI(KiwoomAPIBase):
    ...
    def get_estimated_asset(self) -> Dict[str, Any]:
        ...
        params = {"acnt_no": self.account_no}
        return self.make_tr_request(
            tr_code=self.TR_CODES["estimated_asset"], endpoint="account", data=params
        )
    ...
    def get_account_evaluation(self) -> Dict[str, Any]:
        ...
        params = {"acnt_no": self.account_no}
        return self.make_tr_request(
            tr_code=self.TR_CODES["account_evaluation"], endpoint="account", data=params
        )
    ...
    def get_execution_balance(self) -> Dict[str, Any]:
        ...
        params = {"acnt_no": self.account_no}
        return self.make_tr_request(
            tr_code=self.TR_CODES["execution_balance"], endpoint="account", data=params
        )
    ...
    def get_order_execution_detail(
        ...
        return self.make_tr_request(
            tr_code=self.TR_CODES["order_execution_detail"],
            endpoint="account",
            data=params,
        )
    ...
    def get_next_day_settlement(self) -> Dict[str, Any]:
        ...
        params = {"acnt_no": self.account_no}
        return self.make_tr_request(
            tr_code=self.TR_CODES["next_day_settlement"],
            endpoint="account",
            data=params,
        )
    ...
    def get_order_execution_status(self) -> Dict[str, Any]:
        ...
        params = {"acnt_no": self.account_no}
        return self.make_tr_request(
            tr_code=self.TR_CODES["order_execution_status"],
            endpoint="account",
            data=params,
        )
    ...
    def get_withdrawable_amount(self) -> Dict[str, Any]:
        ...
        params = {"acnt_no": self.account_no}
        return self.make_tr_request(
            tr_code=self.TR_CODES["withdrawable_amount"],
            endpoint="account",
            data=params,
        )
    ...
    def get_orderable_quantity_by_margin(
        ...
        return self.make_tr_request(
            tr_code=self.TR_CODES["orderable_quantity_margin"],
            endpoint="account",
            data=params,
        )
    ...
    def get_orderable_quantity_by_credit(
        ...
        return self.make_tr_request(
            tr_code=self.TR_CODES["orderable_quantity_credit"],
            endpoint="account",
            data=params,
        )
    ...
    def get_margin_detail(self) -> Dict[str, Any]:
        ...
        params = {"acnt_no": self.account_no}
        return self.make_tr_request(
            tr_code=self.TR_CODES["margin_detail"], endpoint="account", data=params
        )
    ...
    def get_current_day_status(self) -> Dict[str, Any]:
        ...
        params = {"acnt_no": self.account_no}
        return self.make_tr_request(
            tr_code=self.TR_CODES["current_day_status"], endpoint="account", data=params
        )
    ...
    def get_balance_detail(self) -> Dict[str, Any]:
        ...
        params = {"acnt_no": self.account_no}
        return self.make_tr_request(
            tr_code=self.TR_CODES["balance_detail"], endpoint="account", data=params
        )
    ...
    def get_unfilled_orders(self) -> Dict[str, Any]:
        ...
        params = {"acnt_no": self.account_no}
        return self.make_tr_request(
            tr_code=self.TR_CODES["unfilled_orders"], endpoint="account", data=params
        )
    ...
    def get_executed_orders(self) -> Dict[str, Any]:
        ...
        params = {"acnt_no": self.account_no}
        return self.make_tr_request(
            tr_code=self.TR_CODES["executed_orders"], endpoint="account", data=params
        )
    ...
    def get_realized_profit_detail(self) -> Dict[str, Any]:
        ...
        params = {"acnt_no": self.account_no}
        return self.make_tr_request(
            tr_code=self.TR_CODES["realized_profit_detail"],
            endpoint="account",
            data=params,
        )
    ...
    def get_account_return(
        ...
        if end_date:
            params["end_dt"] = end_date
        return self.make_tr_request(
            tr_code=self.TR_CODES["account_return"], endpoint="account", data=params
        )
