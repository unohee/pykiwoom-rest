...
class AccountAPI(KiwoomAPIBase):
    ...
    def get_deposit_detail(self) -> Dict[str, Any]:
        ...
        return self.make_tr_request(tr_id=self.TR_CODES["deposit_detail"], data=params)
    ...
    def get_daily_estimated_asset(self, base_date: Optional[str] = None) -> Dict[str, Any]:
        ...
        return self.make_tr_request(tr_id=self.TR_CODES["daily_estimated_asset"], data=params)

    def get_estimated_asset(self) -> Dict[str, Any]:
        """추정자산조회요청 (kt00003)"""
        params = {"acnt_no": self.account_no}
        return self.make_tr_request(tr_id=self.TR_CODES["estimated_asset"], data=params)

    def get_account_evaluation(self) -> Dict[str, Any]:
        """계좌평가현황요청 (kt00004)"""
        params = {"acnt_no": self.account_no}
        return self.make_tr_request(tr_id=self.TR_CODES["account_evaluation"], data=params)

    def get_execution_balance(self) -> Dict[str, Any]:
        """체결잔고요청 (kt00005)"""
        params = {"acnt_no": self.account_no}
        return self.make_tr_request(tr_id=self.TR_CODES["execution_balance"], data=params)
    ...
    def get_order_execution_detail(
        ...
        return self.make_tr_request(tr_id=self.TR_CODES["order_execution_detail"], data=params)

    def get_next_day_settlement(self) -> Dict[str, Any]:
        """계좌별익일결제예정내역요청 (kt00008)"""
        params = {"acnt_no": self.account_no}
        return self.make_tr_request(tr_id=self.TR_CODES["next_day_settlement"], data=params)

    def get_order_execution_status(self) -> Dict[str, Any]:
        """계좌별주문체결현황요청 (kt00009)"""
        params = {"acnt_no": self.account_no}
        return self.make_tr_request(tr_id=self.TR_CODES["order_execution_status"], data=params)

    def get_withdrawable_amount(self) -> Dict[str, Any]:
        """주문인출가능금액요청 (kt00010)"""
        params = {"acnt_no": self.account_no}
        return self.make_tr_request(tr_id=self.TR_CODES["withdrawable_amount"], data=params)
    ...
    def get_orderable_quantity_by_margin(self, stock_code: str, order_price: int) -> Dict[str, Any]:
        ...
        return self.make_tr_request(tr_id=self.TR_CODES["orderable_quantity_margin"], data=params)
    ...
    def get_orderable_quantity_by_credit(self, stock_code: str, order_price: int) -> Dict[str, Any]:
        ...
        return self.make_tr_request(tr_id=self.TR_CODES["orderable_quantity_credit"], data=params)

    def get_margin_detail(self) -> Dict[str, Any]:
        """증거금세부내역조회요청 (kt00013)"""
        params = {"acnt_no": self.account_no}
        return self.make_tr_request(tr_id=self.TR_CODES["margin_detail"], data=params)
    ...
    def get_trading_history(
        ...
        if end_date:
            params["end_dt"] = end_date
        return self.make_tr_request(tr_id=self.TR_CODES["trading_history"], data=params)
    ...
    def get_daily_return_detail(self, base_date: Optional[str] = None) -> Dict[str, Any]:
        ...
        if base_date:
            params["base_dt"] = base_date
        return self.make_tr_request(tr_id=self.TR_CODES["daily_return_detail"], data=params)

    def get_current_day_status(self) -> Dict[str, Any]:
        """계좌별당일현황요청 (kt00017)"""
        params = {"acnt_no": self.account_no}
        return self.make_tr_request(tr_id=self.TR_CODES["current_day_status"], data=params)

    def get_balance_detail(self) -> Dict[str, Any]:
        """계좌평가잔고내역요청 (kt00018)"""
        params = {"acnt_no": self.account_no}
        return self.make_tr_request(tr_id=self.TR_CODES["balance_detail"], data=params)

    def get_unfilled_orders(self) -> Dict[str, Any]:
        """미체결요청 (ka10075)"""
        params = {"acnt_no": self.account_no}
        return self.make_tr_request(tr_id=self.TR_CODES["unfilled_orders"], data=params)

    def get_executed_orders(self) -> Dict[str, Any]:
        """체결요청 (ka10076)"""
        params = {"acnt_no": self.account_no}
        return self.make_tr_request(tr_id=self.TR_CODES["executed_orders"], data=params)

    def get_realized_profit_detail(self) -> Dict[str, Any]:
        """당일실현손익상세요청 (ka10077)"""
        params = {"acnt_no": self.account_no}
        return self.make_tr_request(tr_id=self.TR_CODES["realized_profit_detail"], data=params)
    ...
    def get_account_return(
        ...
        if end_date:
            params["end_dt"] = end_date
        return self.make_tr_request(tr_id=self.TR_CODES["account_return"], data=params)

    def get_unfilled_split_order_detail(self, order_no: str) -> Dict[str, Any]:
        """미체결 분할주문 상세 (ka10088)"""
        params = {"acnt_no": self.account_no, "ord_no": order_no}
        return self.make_tr_request(tr_id=self.TR_CODES["unfilled_split_order"], data=params)
    ...
    def get_daily_trading_diary(self, base_date: Optional[str] = None) -> Dict[str, Any]:
        ...
        if base_date:
            params["base_dt"] = base_date
        return self.make_tr_request(tr_id=self.TR_CODES["daily_trading_diary"], data=params)
