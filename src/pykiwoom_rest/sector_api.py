...
class SectorAPI(KiwoomAPIBase):
    ...
    def get_sector_current_price(self, sector_code: str = "0001") -> Dict[str, Any]:
        ...
        return self.make_tr_request(
            tr_id=self.TR_CODES['sector_current_price'],
            data=params
        )
    ...
    def get_sector_stock_price(self, sector_code: str = "0001") -> Dict[str, Any]:
        ...
        params = {'sect_cd': sector_code}
        return self.make_tr_request(
            tr_id=self.TR_CODES['sector_stock_price'],
            data=params
        )
    ...
    def get_all_sector_index(self) -> Dict[str, Any]:
        ...
        params = {}
        return self.make_tr_request(
            tr_id=self.TR_CODES['all_sector_index'],
            data=params
        )
    ...
    def get_sector_tick_chart(self, sector_code: str, count: int = 100) -> Dict[str, Any]:
        ...
        return self.make_tr_request(
            tr_id=self.TR_CODES['sector_tick_chart'],
            data=params
        )
    ...
    def get_sector_minute_chart(
        ...
        return self.make_tr_request(
            tr_id=self.TR_CODES['sector_minute_chart'],
            data=params
        )
    ...
    def get_sector_daily_chart(
        ...
        return self.make_tr_request(
            tr_id=self.TR_CODES['sector_daily_chart'],
            data=params
        )
    ...
    def get_sector_weekly_chart(
        ...
        return self.make_tr_request(
            tr_id=self.TR_CODES['sector_weekly_chart'],
            data=params
        )
    ...
    def get_sector_monthly_chart(
        ...
        return self.make_tr_request(
            tr_id=self.TR_CODES['sector_monthly_chart'],
            data=params
        )
    ...
    def get_sector_daily_current(self, sector_code: str) -> Dict[str, Any]:
        ...
        params = {'sect_cd': sector_code}
        return self.make_tr_request(
            tr_id=self.TR_CODES['sector_daily_current'],
            data=params
        )
    ...
    def get_sector_yearly_chart(
        ...
        return self.make_tr_request(
            tr_id=self.TR_CODES['sector_yearly_chart'],
            data=params
        )
    ...
    def get_sector_investor_trading(self, sector_code: str) -> Dict[str, Any]:
        ...
        params = {'sect_cd': sector_code}
        return self.make_tr_request(
            tr_id=self.TR_CODES['sector_investor_trading'],
            data=params
        )
    ...
    def get_sector_program_trading(self, sector_code: str) -> Dict[str, Any]:
        ...
        params = {'sect_cd': sector_code}
        return self.make_tr_request(
            tr_id=self.TR_CODES['sector_program_trading'],
            data=params
        )